...
namespace VisualSmart.BizService.Implements.WeChat.Api
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 10)
        {
            ...
            inputObj.SetValue("sign", inputObj.MakeSign(WxPayConfig.PAYKEY));//签名
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
        ...
        */
        public static WxPayData Refund(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData RefundQuery(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
        public static WxPayData ShortUrl(WxPayData inputObj, WxPayConfigDomain WxPayConfig,int timeOut = 6)
        {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData CloseOrder(WxPayData inputObj,WxPayConfigDomain WxPayConfig, int timeOut = 6)
        {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost, WxPayData inputObj, WxPayConfigDomain WxPayConfig)
        {
            
            //如果不需要进行上报
            if (WxPayConfigDomain.REPORT_LEVENL == 0)
            {
                return;
            }

            //如果仅失败上报
            if (WxPayConfigDomain.REPORT_LEVENL == 1 && inputObj.IsSet("return_code") && inputObj.GetValue("return_code").ToString() == "SUCCESS" &&
	    ...
	    */
        public static WxPayData Report(WxPayData inputObj, WxPayConfigDomain WxPayConfig, int timeOut = 1)
        {
            ...
            inputObj.SetValue("sign", inputObj.MakeSign(WxPayConfig.PAYKEY));//签名
            string xml = inputObj.ToXml();
            LogHelper.WeChatLog(string.Format("WxPayApi->Report request :{0}", xml));
            string response = HttpService.Post(xml, url, false, timeOut);
            LogHelper.WeChatLog(string.Format("WxPayApi->Report response :{0}", response));          
        ...
        * 根据当前系统时间加随机序列来生成订单号
         * @return 订单号
        */
        public static string GenerateOutTradeNo(WxPayConfigDomain WxPayConfig)
        {
            var ran = new Random();
