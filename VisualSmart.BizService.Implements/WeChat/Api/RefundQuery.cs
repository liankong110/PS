    ...
    public class RefundQuery
    {
        ...
        */
            ...
            WxPayConfigDomain WxPayConfig)
        {
            ...
            LogHelper.WriteLog("RefundQuery is processing...");
            ...
            WxPayData result = WxPayApi.RefundQuery(data, WxPayConfig);//提交退款查询给API，接收返回数据

            LogHelper.WriteLog("RefundQuery process complete, result : " + result.ToXml());
            return result;
        }
    }
}
