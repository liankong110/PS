...
{
    public interface IWeChatQRCodeBizService : IEntityBizService<WeChatQRCodeDomain>
    {
        /// <summary>
        ...
        WeChatQRCodeDomain IsExistOut_trade_no(string out_trade_no, int Total_amount, string APP_ID);
