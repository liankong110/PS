/// <reference path="../views/layouts/default/partial/navbar/messages.html" />
/// <reference path="directives/ace.js" />
/// <reference path="../views/pages/treeview.html" />
/// <reference path="../views/pages/treeview.html" />
/// <reference path="../views/pages/treeview.html" />
/// <reference path="../views/pages/treeview.html" />
/**
...
var app = angular
  ...
  .config(function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider/**, cfpLoadingBarProvider*/) {
    ...
    $stateProvider
	  ...
	  //.state('ui.treeview', {
	  //    url: '~/Content/angular/views/pages/treeview.html',
	  //  title: 'Treeview',

	  //  templateUrl: '~/Content/angular/views/pages/treeview.html',
